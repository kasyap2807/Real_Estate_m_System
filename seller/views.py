...
def locationspotfound(request, lati,loni,address):
    ...
    data = {'lati': lati, 'loni': loni, 'address': address, 'forms': form, 'items': item}
    ...
    if form.is_valid():
        ...
        # Predict cost based on latitude, longitude, and area
        # predicted_cost = predict_cost(lati, loni, locpdet.propid.ploatarea)
        # locpdet.propid.cost = predicted_cost
        # locpdet.propid.save()
